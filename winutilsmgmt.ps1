...
function Invoke-WPFSourceMGMT {
    ...
    $resourceStart = $inputXML.IndexOf("<Window.Resources>")
    $resourceEnd = $inputXML.IndexOf("</Window.Resources>") #+ 19  # Includes the length of '</Window.Resources>'
    $resourcesXaml = $inputXML.Substring($resourceStart, $resourceEnd - $resourceStart)
    #write-host $resourcesXaml

    # XAML definition of the window
    $xamlSMGMT = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        WindowStyle="None"
        Background="#000000"
        Title="Source MGMT" Height="400" Width="700">
    $resourcesXaml
        ...
        <DataTemplate x:Key="CheckBoxListItemTemplate">
            <StackPanel Orientation="Horizontal">
                ...
                <TextBlock Text="{Binding Path}" VerticalAlignment="Center" Margin="5,0"/>
            </StackPanel>
        </DataTemplate>
    </Window.Resources>
    <Grid Background="#000000">
        ...
        <StackPanel Orientation="Horizontal" Grid.Row="0" Margin="10">
            <Label Content="Enter URL or Path:" VerticalAlignment="Center" Margin="0,0,10,0"/>
            <TextBox x:Name="textBox" Width="300"/>
            <Button Content="Browse" x:Name="browseButton" Margin="5,0" Padding="10,0"/>
        </StackPanel>

        <ListBox x:Name="checkedListBox" Grid.Row="1" Margin="10" Background="#000000"/>

        <StackPanel Orientation="Horizontal" Grid.Row="2" HorizontalAlignment="Right" Margin="10">
            <Button Content="Add" x:Name="addButton" Margin="5,0" Padding="10,0"/>
        </StackPanel>

        <Button x:Name="closeButton" Content="X" HorizontalAlignment="Right" VerticalAlignment="Top"
                Width="30" Height="30" Margin="10" Background="Red" Foreground="White"
                FontWeight="Bold" FontSize="14" BorderThickness="0" Padding="5,3,5,3"/>
    </Grid>
</Window>
"@
    ...
    try {
        ...
        $xmlDocument.LoadXml($xamlSMGMT)
        $xmlReader = [System.Xml.XmlNodeReader] $xmlDocument
        $wpfWindowSMGMT = [System.Windows.Markup.XamlReader]::Load($xmlReader)

        # Get controls by their names
        $textBoxSMGMT = $wpfWindowSMGMT.FindName("textBox")
        $browseButtonSMGMT = $wpfWindowSMGMT.FindName("browseButton")
        $addButtonSMGMT = $wpfWindowSMGMT.FindName("addButton")
        $checkedListBoxSMGMT = $wpfWindowSMGMT.FindName("checkedListBox")
        $closeButtonSMGMT = $wpfWindowSMGMT.FindName("closeButton")

        # Add functionality to the Browse button
        $browseButtonSMGMT.Add_Click({
            $dialog = New-Object Microsoft.Win32.OpenFileDialog
            $dialog.InitialDirectory = [Environment]::GetFolderPath('Desktop')
            # Set filter for JSON files
            $dialog.Filter = "JSON files (*.json)|*.json"
            if ($dialog.ShowDialog() -eq $true) {
                $textBoxSMGMT.Text = $dialog.FileName
            }
        })

        # Add functionality to the Add button
        $addButtonSMGMT.Add_Click({
            $item = New-Object PSObject -Property @{
                Path = $textBoxSMGMT.Text
                IsChecked = $false
            }
            $checkedListBoxSMGMT.Items.Add($item)
        })

        # Add functionality to the Close button
        $closeButtonSMGMT.Add_Click({
            $wpfWindowSMGMT.Close()
        })

        # Show the window
        $wpfWindowSMGMT.ShowDialog() | Out-Null
    }
    catch {
        Write-Host "Error: $_"
    }
                ...
                <Popup Grid.Column="1" Name="SettingsPopup" 
                    ...
                    <Border Background="{MainBackgroundColor}" BorderBrush="{MainForegroundColor}" BorderThickness="1" CornerRadius="0" Margin="0">
                        <StackPanel Background="{MainBackgroundColor}" HorizontalAlignment="Stretch" VerticalAlignment="Stretch">
                            ...
                            <Separator/>
                            <MenuItem Header="Source MGMT" Name="SourceMGMT" Foreground="{MainForegroundColor}"/>
                            <Separator/>
...
<CheckBox Name="WPFTweaksAdobe" Content="Debloat Adobe" Margin="5,0"  ToolTip="Sets Adobe Services to Manual &#38; disable acrobat auto-updates"/>
...
$sync["SourceMGMT"].Add_Click({
  # Handle Source Management item click
  Write-Debug "Source MGMT clicked"
  $sync["SettingsPopup"].IsOpen = $false
  Invoke-WPFSourceMGMT
  $_.Handled = $false
})
